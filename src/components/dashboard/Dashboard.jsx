...
class Dashboard extends Component {
  ...
  loadData() {
    ...
    DataService.getSecondaryData(
      ...
      .then(data => {
        this.setState({
          secondaryHeaders: data["listGrid"]["headers"],
          secondaryRows: data["listGrid"]["rows"]
        });
      })
      .catch(console.log);
  }
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    let context = this.props.context;
    if (
      prevContext.ouUid !== context.ouUid ||
            ...
            <div>
              <Tabs
                items={[
                  {
                    title: "Summary",
                    children: <SummaryDonut rows={this.state.rows} />
                  },
                  {
                    title: "Detail",
                    children: (
                  ...
                  },
                  {
                    ...
                    children: (
                      <ReportTable
                        headers={this.state.secondaryHeaders}
                        rows={this.state.secondaryRows}
                      />
                    )
                  },
                  {
        ...
        <Joyride
          steps={[
            ...
            },
            {
              target: ".btn-toolbar",
              content:
                "Either select relative period or use a custom date range",
              placement: "auto"
            }
          ]}
          run={true}
